...
Import-LocalizedData LocalizedData -filename xFailoverCluster.strings.psd1 -ErrorAction SilentlyContinue
Import-LocalizedData USLocalizedData -filename xFailoverCluster.strings.psd1 -UICulture en-US -ErrorAction SilentlyContinue
